...
int hcd_start(hcd_t *hcdPtr, XScuGic *IntcPtr){
	...
	hcd_IntrEnable(hcdPtr,  HCD_IXR_UI_MASK|HCD_IXR_PC_MASK|HCD_IXR_AA_MASK); //HCD_IXR_PS_MASK| HCD_IXR_UP_MASK |HCD_IXR_UI_MASK|HCD_IXR_UE_MASK|HCD_IXR_PC_MASK|HCD_IXR_AA_MASK|HCD_IXR_ULPI_MASK|HCD_IXR_HCH_MASK|HCD_IXR_RCL_MASK|HCD_IXR_AS_MASK|HCD_IXR_UA_MASK); //0x37
...
//	Xil_DCacheFlush();
//	Xil_DCacheFlushRange(hcdPtr->periodicqTD[1]->buffer[0],32);
//	Xil_DCacheFlushRange(&(hcdPtr->periodicQH[0]->overlay),sizeof(hcdPtr->periodicQH[0]->overlay));
