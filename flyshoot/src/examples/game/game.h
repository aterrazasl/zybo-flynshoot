...
#define GAME_MINES_MAX             50U
#define GAME_MINES_DIST_MIN        10U
#define GAME_SPEED_X               5U
#define GAME_MISSILE_SPEED_X       5U
#define GAME_SHIP_X                100U
#define GAME_SHIP_Y                (GAME_TUNNEL_HEIGHT / 2U)
#define GAME_WALLS_GAP_Y           200U
#define GAME_WALLS_MIN_GAP_Y       100U
