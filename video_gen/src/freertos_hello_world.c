...
int main (void){
	static uint32_t *l_fb = (uint32_t*)0x275464  ;
...
const TickType_t x30mS = pdMS_TO_TICKS( 30UL );


static uint32_t **l_fb =0x275464  ;
